    ...
    if (mtype in ["1", "3", "4"]) and (icao in plane_dict and plane_dict[icao][2] and plane_dict[icao][11]):
        ...
        if tst_int1:
            ...
            if -transit_separation_sound_alert < separation_deg < transit_separation_sound_alert:
                gong()
            if delta_time <= 1:  # Ustaw flagę tranzytu jeśli czas do tranzytu jest mniejszy lub równy 1 sekundy / Set transit flag if time to transit is less than or equal to 1 second
